...
>
> **진행**: B-1·B-2·B-3 **해결 완료(2026-08-02)** — 즉시 착수분 전부 소진. B-4는 P5 사이클, B-5는 P5 착수 시.
...
| B-4 | **신성 모독 저주당 점유·"룬 잔류물" 실명** — 정신력 축 장부가 이 2건으로 미완 | **P5 사이클** (인게임 정보창 확인 필요) | 미검증 가설 목록의 해당 항목 → 인게임 실험 → 결과를 KB 수록(IN_GAME) → 다음 생성에 반영. P5의 왕복 1회 실증 후보로 우선 사용 | 정신력 축 장부가 미상 0건으로 닫힘 |
